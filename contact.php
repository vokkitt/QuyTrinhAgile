...
if(isset($_POST['form_contact']))
{
    ...
    {
        $valid = 0;
        $error_message .= 'Nhập tên của bạn !.\n';
    }

    if(empty($_POST['visitor_phone']))
    {
        $valid = 0;
        $error_message .= 'Nhập số điện thoại của bạn !.\n';
    }
    ...
    {
        $valid = 0;
        $error_message .= 'Nhập email của bạn !.\n';
    }
    else
    {
    ...
    {
        $valid = 0;
        $error_message .= 'Vui lòng nhập tin nhắn muốn gửi !.\n';
    }
...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="visitor_message" class="form-control" rows="9" cols="25" placeholder="..."></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <input type="submit" value="Gửi" class="btn btn-search pull-right" style="padding: 10px 30px;" name="form_contact">
                                </div>
                            </div>
                            </form>
                        </div>
                    ...
                    <div class="col-md-4">
                        <legend><span class="glyphicon glyphicon-globe"></span> Hệ thống cửa hàng </legend>
                        <address>
