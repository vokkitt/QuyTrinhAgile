                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    <label for=""><?php echo "Xác thực mật khẩu" ?> *</label>
                                    <input type="password" class="form-control" name="cust_re_password">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for=""></label>
                                    <input type="submit" class="btn btn-search" style="padding: 10px 30px;" value="<?php echo "ĐĂNG KÝ" ?>" name="form1">
                                </div>
                            </div>
                        </div>                        
                    </form>
