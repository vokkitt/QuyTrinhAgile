...
<head>
	...
	if($cur_page == 'index.php' || $cur_page == 'login.php' || $cur_page == 'registration.php' || $cur_page == 'cart.php' || $cur_page == 'checkout.php' || $cur_page == 'forget-password.php' || $cur_page == 'reset-password.php' || $cur_page == 'product-category.php' || $cur_page == 'product.php') {
		?>
		<title><?php echo "BROKEN RADAR - Sàn thương mại điện tử Việt Nam"; ?></title>
	...
	if($cur_page == 'about.php') {
		?>
		<title><?php echo "Về chúng tôi" ?></title>
	...
	if($cur_page == 'contact.php') {
		?>
		<title><?php echo "Thông tin liên hệ" ?></title>
			...
			<div class="col-md-5 right">
				<ul class="login-logout">
					...
					if(isset($_SESSION['customer'])) {
						?>
						<li><a href="dashboard.php"><i class="fa fa-user"></i></a></li>
						<li><?php echo "Xin chào" ?> <?php echo $_SESSION['customer']['cust_name']; ?></li>
						<?php
					} else {
						?>
						<li><a href="login.php"></i> <?php echo "Đăng nhập "; ?></a></li>
						<li><a href="registration.php"> <?php echo "Đăng ký"; ?></a></li>
						<?php	
					}
					?>
			...
			<div class="col-md-3 search-area">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					...
					<div class="form-group">
						<input type="text" class="khung-search form-control search-top" placeholder="" name="search_text">
					</div>
