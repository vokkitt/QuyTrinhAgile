...
if (isset($_POST['form1'])) {
    ...
    $_SESSION['customer']['cust_s_name'] = 'a';
    $_SESSION['customer']['cust_s_cname'] = 'a';
    $_SESSION['customer']['cust_s_phone'] = '091234';
    $_SESSION['customer']['cust_s_country'] = 'VN';
    $_SESSION['customer']['cust_s_address'] = 'aa';
    $_SESSION['customer']['cust_s_city'] = 'a';
    $_SESSION['customer']['cust_s_state'] = 'a';
    $_SESSION['customer']['cust_s_zip'] = '8400';
            ...
            <div class="col-md-12">
                <div class="user-content">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h3><?php echo "Địa chỉ lấy hàng 1" ?></h3>
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo "Công ty" ?></label>
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo "Huyện" ?></label>
                            ...
                            <div class="col-md-6">
                                <h3><?php echo "Địa chỉ lấy hàng 2" ?></h3>
                                <div class="form-group">
                                    <label for=""><?php echo "Họ tên" ?></label>
                        ...
                        <input type="submit" class="btn btn-search" style="padding: 10px 30px;" value="<?php echo "Lưu" ?>" name="form1">
                    </form>
                </div>                
            </div>
        </div>
