					...
					<div class="row">
						...
						<div class="col-md-7">
							...
							<div class="p-price">
                                ...
                                <span>
                                    <?php if($p_old_price!=''): ?>
                                        <del><?php echo number_format($p_old_price); ?> đ</del>
                                    <?php endif; ?> 
                                        <?php echo number_format($p_current_price); ?> đ
                                </span>
                            </div>
...
<div class="product bg-gray pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2><?php echo "Sản phẩm tương tự" ?></h2>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    foreach ($result as $row) {
                        ...
                        <div class="item">
                            ...
                            <div class="text">
                                ...
                                <h4>
                                    <?php echo number_format($row['p_current_price']); ?> đ
                                    <?php if($row['p_old_price'] != ''): ?>
                                    <del>
                                        <?php echo number_format($row['p_old_price']); ?> đ
                                    </del>
                                    <?php endif; ?>
                                </h4>
                                <div class="rating">
                                ...
                                <p><a href="product.php?id=<?php echo $row['p_id']; ?>"><?php echo "Thêm vào giỏ" ?></a></p>
                            </div>
                        </div>
                        <?php
                    }
