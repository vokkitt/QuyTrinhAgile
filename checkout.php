        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['customer'])): ?>
                    <p>
                        <a href="login.php" class="btn btn-search" style="padding: 10px 30px;"><?php echo "Vui lòng đăng nhập" ?></a>
                    </p>
                <?php else: ?>

                <h3 class="special"><?php echo "Đơn hàng thanh toán" ?></h3>
                <div class="cart">
                    <table class="table table-responsive table-hover table-bordered">
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo number_format($shipping_cost); ?> đ</td>
                        </tr>
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                ?>
                                <?php echo number_format($final_total); ?> đ
                            </th>
                        </tr>
                    </table> 
                </div>
                ...
                <div class="billing-address">
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="special"><?php echo "Địa chỉ 1" ?></h3>
                        ...
                        <div class="col-md-6">
                            <h3 class="special"><?php echo "Địa chỉ 2" ?></h3>
                            <table class="table table-responsive table-bordered table-hover table-striped bill-address">
                                <tr>
                                    <td><?php echo "Tên" ?></td>
		                	...
		                	<div class="col-md-4">
	                            <div class="row">
	                                <div class="col-md-12 form-group">
	                                    <label for=""><?php echo "Lựa chọn phương thức" ?> *</label>
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
	                                        <option value=""><?php echo "..." ?></option>
	                                        <option value="PayPal"><?php echo "Paypal" ?></option>
	                                        <option value="Bank Deposit"><?php echo "Ship COD" ?></option>
                                            <option value="Momo"><?php echo "Momo" ?></option>
	                                    </select>
	                                </div>
                                    <form class="paypal" action="<?php echo BASE_URL; ?>payment/payment_process.php" method="post" id="paypal_form" target="_blank">
                                        ...
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-search" style="padding: 10px 30px;" value="<?php echo "Thanh toán" ?>" name="form1">
                                        </div>
                                    </form>
                                    <form action="payment/bank/init.php" method="post" id="bank_form">
                                        ...
                                        <div class="col-md-12 form-group" >
                                            <label for=""><?php echo "Ghi chú" ?> <br><span style="font-size:12px;font-weight:normal;">(<?php echo "Vui lòng ghi chú" ?>)</span></label>
                                            <textarea name="transaction_info" class="form-control" cols="30" rows="10"></textarea>
                                        </div>
                                        <div class="col-md-12 form-group" >
                                            <input type="submit" class="btn btn-search" style="padding: 10px 30px;" value="<?php echo "Thanh toán" ?>" name="form3">
                                        </div>
                                    </form>
                                    
                                    <div id="momo_form" >
                                        <form  class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="payment/momo/xulythanhtoanmomo.php">
                                                <input type="submit" name="momo" value="MOMO QRcode" class="btn btn-search" style="margin:10px;padding:10px 20px;">
                                        </form>

                                        <form  class="" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="payment/momo/xulythanhtoanmomo_atm.php">
                                                <input type="submit" name="momo" value="MOMO ATM" class="btn btn-search" style="margin:10px;padding:10px 20px;">
                                        </form>
                                    </div>
